...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1653}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.5950}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0978}}
...
\begin{center}\includegraphics[width=1\linewidth]{./images/image120} \end{center}

\href{images/image120.png}{Click here to enlarge the image}
...
\begin{center}\includegraphics[width=1\linewidth]{./images/image122} \end{center}

\href{images/image122.png}{Click here to enlarge the image}
...
\begin{center}\includegraphics[width=1\linewidth]{./images/image124} \end{center}

\href{images/image124.png}{Click here to enlarge the image}
...
\begin{center}\includegraphics[width=1\linewidth]{./images/image126} \end{center}

\href{images/image126.png}{Click here to enlarge the image}
