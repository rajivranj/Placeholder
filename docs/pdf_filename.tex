...
\hypertarget{category-scheme}{%
\section{Category scheme}\label{category-scheme}}

A Category Scheme groups similar objects based on shared characteristics, providing a hierarchical structure that helps classify and organise data and metadata meaningfully.
