...
Recalling our two initial tables (table: \@ref(tab:table41) and table: \@ref(tab:table42)), we will now generate DSDs, ContentConstraints and Dataflows. We will also create a CategoryScheme. We can create all these artefacts through the Table Modeller option in the SDMX Constructor.
...
## Uploading XML file to the DLM {#upload-the}
